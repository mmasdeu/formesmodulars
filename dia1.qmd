...
*Prova:* Ens cal primer veure la convergència de la sèrie per tot $z$. Considerem primer $z\in D$ fixat, i podem veure fàcilment que $|c z + d|^2 \geq c^2-cd+d^2= |c\rho + d|^2$. Com que
$$
